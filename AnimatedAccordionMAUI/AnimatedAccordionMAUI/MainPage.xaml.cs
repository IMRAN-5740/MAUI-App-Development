namespace AnimatedAccordionMAUI
{
    public partial class MainPage : ContentPage
    {
        ...
        protected override void OnSizeAllocated(double width, double height)
        {
            ...
            _height = itemsFunction.Height;
            _width = itemsFunction.Width;
        }
#endif
        ...
        void TapGestureRecognizer_Tapped(System.Object sender, System.EventArgs e)
        {
            ...
            var animation = new Animation(delta =>
            {
                if (!_collapsed) //Collapsing
                {
                    ...
                    (itemsFunction.HeightRequest, itemsFunction.WidthRequest) = (newHeight, newWidth);
                }
                else //Expanding
                {
            ...
            iconFunction.RotateTo(_collapsed ? 90 : -90);
